...
import { StyleSheet, View, Text, TouchableOpacity, Image, ImageBackground, Dimensions, Alert, ScrollView, Linking } from 'react-native';
...
import RNRestart from 'react-native-restart'; // Importer RNRestart
...
export default function App() {
  ...
  const reloadApp = () => {
    RNRestart.Restart(); // Utiliser RNRestart pour redémarrer l'application
  };
